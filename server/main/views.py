...
class GenerateUpskilling(View):
    def post(self,request):
        ...
        sourceA and sourceB will be resources for skillA. sourceC and sourceD will be skillB. assessmentA will be for skillA and assessmentB will be for skillB. These are just placeholders for the data, do not put this as the response.
